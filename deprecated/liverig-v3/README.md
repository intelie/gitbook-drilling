...
* A new plugin, plugin-assets, was created to centralize generic assets features and source code ([more](https://github.com/intelie/drilling/blob/main/deprecated/liverig-v3/broken-reference/README.md))
