...
![New option to start a batch renormalization](<../../.gitbook/assets/image (493).png>)

![Full history of renormalizations executed in the platform](<../../.gitbook/assets/image (148).png>)
